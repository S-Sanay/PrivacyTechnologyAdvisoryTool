# Privacy Technology Advisory Tool

An interactive web application that guides users to the most appropriate privacy-enhancing technology for their scenario. Answer 14 questions about your data, threat model, and constraints — the tool recommends one of five technologies (Anonymization, Differential Privacy, Secure Multi-Party Computation, Federated Learning, or Legal/Constitutional Frameworks) along with specific parameter settings, tradeoff visualizations, a rejection analysis of alternatives, and a phased implementation roadmap.
